...
button_sub=Button(root,text="-",padx=40, pady=20,command=lambda:button_click("-")).grid(row=5,column=0)
button_mul=Button(root,text="/",padx=40, pady=20,command=lambda:button_click("/")).grid(row=5,column=1)
button_div=Button(root,text="",padx=40, pady=20,command=lambda:button_click("")).grid(row=5,column=2)
button_add=Button(root,text="+",padx=40, pady=20,command=lambda:button_click("+")).grid(row=4,column=0)
button_clear=Button(root,text="c",padx=40, pady=20, command=button_clear).grid(row=4,column=2)
button_equal=Button(root,text="=",padx=40, pady=20,width=20, command=button_equal,borderwidth=5).grid(row=6,column=0,columnspan=5)
root.mainloop()
